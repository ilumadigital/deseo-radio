(function () {
    ...
    function ensureUi() {
        ...
        style.textContent = [
            ...
            '.deseo-dialog-body{min-height:0;overflow:auto;padding:17px 28px 27px;color:#aaaab1;font-size:16px;line-height:1.65;white-space:pre-line;overflow-wrap:anywhere}',
            ...
            '.deseo-dialog-button{min-width:0;min-height:52px;padding:11px 22px;border-radius:999px;border:1px solid rgba(255,255,255,.11);background:#0a0a0c;color:#d4d4d8;font:800 14px "Google Sans",Arial,sans-serif;letter-spacing:.035em;text-transform:uppercase;white-space:normal;text-align:center;overflow-wrap:anywhere;cursor:pointer;transition:.18s ease}',

(function () {
    ...
    function ensureUi() {
        ...
        style.textContent = [
            ...
            '.deseo-dialog-card{width:min(100%,520px);max-height:calc(100dvh - 24px);overflow:hidden;display:flex;flex-direction:column;border:1px solid rgba(255,255,255,.12);border-radius:28px;background:radial-gradient(circle at 92% 0,rgba(255,43,54,.12),transparent 32%),linear-gradient(145deg,#151517,#0b0b0d);box-shadow:0 38px 120px rgba(0,0,0,.62),inset 0 1px 0 rgba(255,255,255,.035);color:#fff;font-family:"Google Sans",Arial,sans-serif;transform:translateY(12px) scale(.985);opacity:0;transition:transform .18s ease,opacity .18s ease}',
            '.deseo-dialog-root.is-visible .deseo-dialog-card{transform:none;opacity:1}',
            '.deseo-dialog-head{padding:27px 28px 0}',
            '.deseo-dialog-kicker{display:flex;align-items:center;gap:10px;color:#ff2b36;font-size:13px;font-weight:900;letter-spacing:.12em;text-transform:uppercase}',
            ...
            '.deseo-dialog-body{min-height:0;overflow:auto;padding:17px 28px 27px;color:#aaaab1;font-size:15px;line-height:1.65;white-space:pre-line;overflow-wrap:anywhere}',
            '.deseo-dialog-input{width:100%;min-height:54px;margin-top:16px;padding:0 16px;border:1px solid rgba(255,255,255,.11);border-radius:14px;background:#070708;color:#fff;font:500 15px "Google Sans",Arial,sans-serif;outline:none}',
            '.deseo-dialog-input:focus{border-color:rgba(255,43,54,.48);box-shadow:0 0 0 3px rgba(255,43,54,.07)}',
            '.deseo-dialog-actions{display:flex;flex-wrap:wrap;justify-content:flex-end;gap:9px;padding:0 28px 27px}',
            '.deseo-dialog-button{min-width:0;min-height:52px;padding:11px 22px;border-radius:999px;border:1px solid rgba(255,255,255,.11);background:#0a0a0c;color:#d4d4d8;font:800 13px "Google Sans",Arial,sans-serif;letter-spacing:.035em;text-transform:uppercase;white-space:normal;text-align:center;overflow-wrap:anywhere;cursor:pointer;transition:.18s ease}',
            ...
            '@media(max-width:620px){.deseo-dialog-root{align-items:flex-end;padding:12px}.deseo-dialog-card{border-radius:24px}.deseo-dialog-head{padding:24px 21px 0}.deseo-dialog-title{font-size:28px}.deseo-dialog-body{padding:15px 21px 23px;font-size:15px}.deseo-dialog-actions{display:grid;grid-template-columns:1fr 1fr;padding:0 21px 21px}.deseo-dialog-button{width:100%;padding:0 12px;font-size:13px}.deseo-dialog-actions.single{grid-template-columns:1fr}}'
        ].join('');

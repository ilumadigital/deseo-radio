...
<main id="main-content" class="dj-legal-page">
    <div class="dj-legal-shell">
        ...
        <div class="dj-legal-content">
            ...
            <section class="dj-legal-section">
                <h2>4. Κράτηση ημέρας και ώρας</h2>
                <p>
                    Ο DJ επιλέγει αποκλειστικά από τα slots που εμφανίζονται ως διαθέσιμα στη φόρμα. Ένα slot
                    θεωρείται δεσμευμένο μόνο μετά την επιτυχή ολοκλήρωση της υποβολής. Το Deseo Radio δεν
                    δημοσιοποιεί σε άλλους χρήστες το όνομα, το email ή άλλα στοιχεία του προσώπου που έχει
                    ήδη δεσμεύσει ένα slot.
                </p>
                <p>
                    Το Deseo Radio διατηρεί το δικαίωμα να μεταβάλει ή να ακυρώσει ώρα μετάδοσης όταν υπάρχει
                    τεχνικός, προγραμματιστικός, νομικός ή άλλος ουσιώδης λόγος. Σε περίπτωση ουσιώδους αλλαγής,
                    θα επιδιώκεται προηγούμενη ενημέρωση του DJ μέσω του email που έχει δηλώσει.
                </p>
            </section>
            ...
            <section class="dj-legal-section">
                ...
                <p>
                    ...
                    μπορούν να κοινοποιούνται ξεχωριστά από την ομάδα ILUMA / Deseo. Η μη έγκαιρη ή μη συμβατή
                    παράδοση μπορεί να οδηγήσει σε απώλεια του slot.
                </p>
            </section>

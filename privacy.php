    ...
    <div class="dj-legal-shell">
        ...
        <div class="dj-legal-content">
            ...
            <section class="dj-legal-section">
                ...
                <ul>
                    <li>διαχείριση της αίτησης και δέσμευση του Season 6 slot,</li>
                    ...
                    <li>ασφάλεια, αποτροπή διπλών κρατήσεων και απόδειξη της αποδοχής των όρων.</li>
                </ul>
            </section>
            ...
            <section class="dj-legal-section">
                ...
                <p>
                    Το public booking interface εμφανίζει μόνο αν ένα slot είναι διαθέσιμο ή μη διαθέσιμο και δεν
                    επιστρέφει τα προσωπικά στοιχεία του DJ που το έχει δεσμεύσει. Η τελική κράτηση προστατεύεται
                    σε επίπεδο βάσης δεδομένων ώστε να αποτρέπεται double booking.
                </p>
                <p>

<header class="site-header deseo-header" id="top">
    <div class="shell header-inner deseo-header-inner">
        <a class="brand deseo-brand" href="/" aria-label="Deseo Radio αρχική">
            <img src="/assets/img/deseoradio-logo.png" alt="Deseo Radio" width="220" height="62">
        </a>

        <div class="header-actions deseo-header-actions">
            <a class="deseo-live-pill" href="#main-content" aria-label="Μετάβαση στο live player">
                <span class="deseo-live-dot"></span>
                <span>LIVE</span>
            </a>

            <a class="icon-link deseo-social" href="https://www.instagram.com/deseoradio/" target="_blank" rel="noopener noreferrer" aria-label="Deseo Radio στο Instagram">
            ...
            <a class="icon-link deseo-social" href="https://www.facebook.com/deseoradiogr/" target="_blank" rel="noopener noreferrer" aria-label="Deseo Radio στο Facebook">
                <svg viewBox="0 0 24 24" aria-hidden="true">
